...
class TipsCog(commands.Cog):
    ...
    async def tips(self, ctx):
        ...
        embed.add_field(name="Steps",
                        ...
                        inline=False)
        embed.add_field(name="Guidance Scale",
        ...
        embed.add_field(name="Seed",
                        ...
                        inline=False)
        embed.add_field(name="Prompting",
                        ...
                        inline=False)
        embed.add_field(name="Emphasizing",
                        value="`(word)`-each `()` increases attention to `word` by 1.1x\n`[word]`-each `[]` decreases "
                              ...
                              "in prompt.",
                        inline=False)
        embed.add_field(name="Transitioning",
                        ...
                        inline=False)
        embed.add_field(name="Alternating",
